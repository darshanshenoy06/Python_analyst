...
Combines two DataFrames using one or more common columns (keys).
...
Creates an Excel-like summary table.
...
Selects or updates rows and columns using labels.

Unlike iloc(), loc() works with row labels and column names.
...
3. Concatenate Monthly Data
4. Create Pivot Tables
5. Update Values using loc()
6. Convert Datatypes using astype()
...
# Complete Pandas Topics Covered
